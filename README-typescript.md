# Setup typescript-tools plugin

As of 2026 I am using the typescript-tools plugin.  See https://github.com/pmizio/typescript-tools.nvim

See `lua/core/plugins/typescript-tools.lua` for the minimal config.
